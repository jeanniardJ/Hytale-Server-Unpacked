    ...
    if (paramClass.isAssignableFrom(RawEncodedKeySpec.class)) {
      ...
      if (paramKey instanceof EdECPrivateKey) {
        ...
        if (optional.isPresent())
          return new EdECPrivateKeySpec(((EdECPrivateKey)paramKey).getParams(), optional.get()); 
      ...
      return new EdECPublicKeySpec(((EdECPublicKey)paramKey).getParams(), ((EdECPublicKey)paramKey).getPoint());
    } 
...
/* Location:              D:\Workspace\Hytale\Modding\TestMod\app\libs\HytaleServer.jar!\META-INF\versions\15\org\bouncycastle\jcajce\provider\asymmetric\edec\KeyFactorySpi.class
